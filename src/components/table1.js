...
const CustomTable = ({
  ...
  setMonthlyTotals, monthlyTotals, updatedcentroCostos, userId, CentroCostoid, setCentroCostoid, presupuestoid
  ...
  const processImportedData = (data) => {
    ...
    for (let i = 1; i < data.length; i++) {
      ...
      // Finalmente, agregar el ítem al subrubro
        ...
        <DialogContent>
          ...
          {selectedSubrubro && (
            Array.isArray(updatedcentroCostos) && updatedcentroCostos.length > 0 ? (
              ...
              alignItems: 'center'}}>No Hay Centro De Costos habilitados</Typography>
            )
          )}
        </DialogContent>
        <DialogActions>
